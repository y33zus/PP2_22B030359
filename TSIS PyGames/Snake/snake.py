...
difficulty_levels = {
    1: {'speed': 15, 'points': 100},
    2: {'speed': 20, 'points': 300},
    3: {'speed': 25, 'points': 500},
}
level=1
snake_speed = difficulty_levels[level]['speed']

#отоброжении level
def show_level(choice, color, font, size):
     # создание объекта шрифта level_font
...
while True :
    ...
    if score >= difficulty_levels[level]['points']:
        level += 1
        score = 0
        snake_speed = difficulty_levels[level]['speed']
    ...
    if snake_position[0] == fruit_position[0]+40 and snake_position[1] == fruit_position[1]+40 :
        score += 10
        fruit_spawn = False
    else :
        snake_body.pop()
    ...
    pygame.draw.rect(game_window, white, pygame.Rect(
        fruit_position[0], fruit_position[1], 50, 50))
